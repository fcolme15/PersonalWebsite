      ...
      <div className="flex bg-n-8 items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem] xl:mr-8" href="/#hero">
          <div className="flex items-center px-5 space-x-3">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold text-white">FranciscoJC</h1>
          </div>
        </a>
        ...
        <nav
          ...
          } fixed top-[4.5rem] left-0 right-0 bottom-0 bg-n-8 z-40 lg:static lg:flex lg:ml-auto lg:bg-transparent`}
        >
            ...
            {navigation.map((item) => (
              <Link
                ...
                className={`block relative font-code text-2xl uppercase text-n-1 transition-colors hover:text-color-1 
                  ...
                  item.title?.toLowerCase() === 'contact' ? 'lg:bg-black lg:rounded-md lg:border lg:my-2 lg:py-2' : ''
                } after:content-[''] after:absolute after:left-8 after:bottom-5 after:h-[2px] after:bg-n-1 after:transition-all after:duration-300 after:w-0 lg:hover:after:w-1/3 lg:after:left-1/2 lg:after:transform lg:after:-translate-x-1/2 ${
